      ...
      <div className='w-full min-h-[150px] flex items-center gap-x-4'>
        ...
        <div className='w-full flex flex-col'>
          <div className='flex justify-between mb-2'>
            <Link to={`/product/${title}`} className='text-sm font-medium max-w-[240px] text-primary hover:underline'>{title}</Link>
            <div className='text-xl cursor-pointer'>
              <IoMdClose onClick={() => removeFromCart(id)} className='text-gray-500 hover:text-green-400 transition' />
            </div>
          </div>
